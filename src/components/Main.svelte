<script>
  ...
  let steps = [
    {
      ...
      description:
        "The Add to Cart app leverages Firebase Realtime Database to provide real-time product management. Built with React and Firebase, the app delivers an engaging and responsive user interface.",
      href: "https://add-to-cart-suren.netlify.app/",
    },
    {
      name: "Weather App using API",
      icon: "fa-solid fa-bolt",
      description:
        "The Weather App provides users with real-time weather updates. Built with React, it fetches weather data from a reliable API and displays current conditions. Hosted on Netlify, this app offers a responsive design and easy-to-use features for accurate weather information.",
    ...
    },
    {
      ...
      description: "The feedback app",
      href: "https://github.com/SurendharSSenthil/course-survey",
    },
    {
  ...
  let benefits = [
    ...
    },
    {
      ...
      name: "a meticulous coder",
      description:
        "Attention to detail is at the core of my development process. From ensuring precise alignment in UI designs to writing clean, maintainable code, I focus on delivering high-quality work that meets and exceeds project requirements.",
    },
  ];
...
>
  <h1 class="font-medium flex flex-row gap-4">
    ...
    <div class="flex gap-2 items-center">
      <button
        class="bg-violet-400 w-[12px] h-[20px] rounded-sm"
        on:click={() => buttonClicked(0)}
      ></button>
      <button
        class="bg-red-400 w-[12px] h-[20px] rounded-sm"
        on:click={() => buttonClicked(1)}
      ></button>
      <button
        class="bg-orange-400 w-[12px] h-[20px] rounded-sm"
        on:click={() => buttonClicked(2)}
      ></button>
      <button
        class="bg-yellow-400 w-[12px] h-[20px] rounded-sm"
        on:click={() => buttonClicked(3)}
      ></button>
      <button
        class="bg-blue-400 w-[12px] h-[20px] rounded-sm"
        on:click={() => buttonClicked(4)}
      ></button>
      <button
        class="bg-green-400 w-[12px] h-[20px] rounded-sm"
        on:click={() => buttonClicked(5)}
      ></button>
    </div>
  </h1>
  <div class="sm:flex items-center gap-4 hidden">
    {#each tabs as tab, index}
      <a href={tab.link} target={index === 2 ? "_blank" : ""}>
        <p>{tab.name}</p>
      </a>
    {/each}
  </div>
...
<main class="flex flex-col flex-1 p-4">
  <section
    id="introPage"
    class="grid grid-cols-1 lg:grid-cols-2 gap-10 py-2 sm:py-10"
  >
    <div
      ...
      <a href="https://blog-client-ten-jade.vercel.app/" target="_blank">
        ...
        >
          ...
          <h4 class="relative z-9 font-semibold">
            My<span class=" font-semibold" style:color={cool}>Verse</span> &rarr;
          </h4>
        </button>
      </a>
    </div>
  ...
  <section class="py-20 lg:py-32 flex flex-col gap-24" id="projects">
    <div class="group flex flex-col relative gap-[10px]">
      ...
      <!-- <div class="relative"> -->
      <div
        class="absolute top-10 left-0 w-full h-1 bg-purple-500 transform scale-x-0 origin-left transition-transform duration-300 group-hover:scale-x-100"
      ></div>
      <!-- </div> -->
    </div>
      ...
      <Step step={steps[1]}>
        <p>
          The Weather App is an application developed with <strong
            class="text-violet-400">React</strong
          >. It provides real-time weather updates by fetching data from a
          reliable API. The app features a responsive design for an engaging
          user experience, ensuring accurate weather information at your
          fingertips.
        </p>
      </Step>
      <Step step={steps[2]}>
        <p>
          The Portfolio is a website developed with <strong
            class="text-violet-400">HTML, CSS and JavaScript</strong
          >
        </p>
      </Step>
      ...
      <Step step={steps[0]}>
        <p>
          The Add to Cart app is a seamless shopping experience created with <strong
            class="text-violet-400">React and Firebase Realtime Database</strong
          >. It allows users to manage their shopping cart in real-time and a
          smooth checkout process. The app's integration with Firebase ensures
          real-time synchronization and a responsive user interface.
        </p>
      </Step>
      <Step step={steps[3]}>
        <p>
          The Feedback App is an efficient feedback collection and management
          tool built with <strong class="text-violet-400"
            >React, Node.js, and MongoDB (MERN)</strong
          >. It allows users to submit feedback and view real-time updates,
          while administrators can easily manage and analyze responses. The
          app's architecture ensures seamless data handling and a user-friendly
          interface.
        </p>
      </Step>
      ...
      <Step step={steps[4]}>
        <p>
          The Attendance Management System is a powerful tool built with <strong
            ...
            >MERN Stack (MongoDB, Express.js, React, Node.js)</strong
          >. It facilitates real-time attendance tracking, dynamic reporting,
          and an intuitive user interface to streamline attendance management
          for educational institutions.
        </p>
      </Step>
      <Step step={steps[5]}>
        <p>
          <strong class="text-violet-400">MyVerse</strong> is a personal blog
          built with the
          <strong class="text-violet-400">
            MERN Stack (MongoDB, Express.js, React, Node.js)</strong
          >, offering a seamless and interactive platform where readers can
          explore, comment, like, and dislike posts. It's designed to provide an
          engaging reading experience, bringing thoughts and ideas to life.
        </p>
      </Step>
    </div>
  </section>
    ...
    <div class="flex flex-col gap-20 w-full mx-auto max-w-[800px]">
      {#each benefits as benefit, index (benefit.name)}
        <div class="group flex flex-col relative pb-2">
          ...
          <div
            class="absolute bottom-0 left-0 w-full h-1 bg-purple-500 transform scale-x-0 origin-left transition-transform duration-300 group-hover:scale-x-100 mt-4"
          ></div>
        </div>
      {/each}
    </div>
  ...
  >
    ...
    <p class="mx-auto">
      Want more details on my journey? Check out my <a
        href="https://linkedin.com/in/SurendharSSenthil"
        class="text-violet-400">LinkedIn</a
      >.
    </p>
  </section>
  ...
  >
    ...
    >
      <h6 class="text-large sm:text-xl md:text-2xl">
        Want to see my GitHub activity?
      </h6>
      <h3 class="font-semibold text-3xl sm:text-4xl md:text-5xl">
        My GitHub <span class="poppins text-violet-400">Contributions</span>
      </h3>
    </div>
    ...
    <p class="mx-auto">
      Explore more of my repositories and contributions on <a
        href="https://github.com/SurendharSSenthil"
        class="text-violet-400">GitHub</a
      >.
    </p>
  </section>
  <section
    ...
    <div class="flex md:flex-row flex-col justify-between items-center gap-8">
      ...
      <div class="flex flex-wrap justify-center gap-4">
        {#each skills as skill, i (skill.name)}
          <div
            class="bg-slate-950 relative anim text-center flex flex-row items-center justify-between gap-3 rounded-3xl"
          >
            <i class={skill.icon + " text-2xl"} style="color: {skill.color};"
            ></i>
...
<style>
  ...
  .typewriter {
    ...
    width: 10ch;
    animation:
      typing 3s steps(10, end) 1s 1 normal both,
